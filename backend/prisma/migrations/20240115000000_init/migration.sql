-- CreateEnum
CREATE TYPE "InstitutionType" AS ENUM ('PRIVATE', 'GOVERNMENT');

-- CreateEnum
CREATE TYPE "GovInstitution" AS ENUM ('IMSS', 'ISSSTE', 'INSABI', 'IMSS_BIENESTAR', 'SEDENA', 'SEMAR', 'INAH', 'INBA', 'SEP', 'UNAM', 'IPN', 'PEMEX', 'CFE', 'SAT', 'BANXICO', 'CONAGUA', 'INEGI', 'OTHER');
...
-- CreateEnum
CREATE TYPE "BenefitType" AS ENUM ('FOOD_VOUCHERS', 'SAVINGS_FUND', 'BONUS', 'LIFE_INSURANCE', 'MAJOR_MEDICAL', 'PRODUCTIVITY_BONUS', 'ATTENDANCE_BONUS', 'PUNCTUALITY_BONUS', 'TRANSPORTATION', 'QUINQUENIO', 'ESTIMULO_ANTIGUEDAD', 'AYUDA_LENTES', 'AYUDA_DEFUNCION', 'CANASTA_BASICA', 'AYUDA_GUARDERIA', 'AYUDA_ESCOLAR', 'BONO_DIA_MADRE', 'BONO_DIA_PADRE', 'BONO_NAVIDAD', 'BONO_REYES', 'BONO_ANIVERSARIO', 'PRIMA_DOMINICAL', 'COMPENSACION_RIESGO', 'SERVICIO_MEDICO', 'PENSION_COMPLEMENTARIA', 'SEGURO_RETIRO', 'SEGURO_SEPARACION', 'PRESTAMO_PERSONAL', 'PRESTAMO_HIPOTECARIO', 'VALES_ROPA', 'CREDENCIAL_ISSSTE', 'SUBSIDIO_COMEDOR', 'TURNO_EXTRA', 'OTHER');
...
CREATE TABLE "companies" (
    ...
    "name" TEXT NOT NULL,
    "rfc" TEXT NOT NULL,
    "institution_type" "InstitutionType" NOT NULL DEFAULT 'PRIVATE',
